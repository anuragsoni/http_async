...
let text =
  Bigstring.of_string
    "CHAPTER I. Down the Rabbit-Hole  Alice was beginning to get very tired of sitting \
     ...
     could, for the hot day made her feel very sleepy and stupid), whether the pleasure \
     ...
     way to hear the Rabbit say to itself, <Oh dear! Oh dear! I shall be late!> (when \
     ...
     in time to see it pop down a large rabbit-hole under the hedge. In another moment \
     down went Alice after it, never once considering how in the world she was to get \
     out again. The rabbit-hole went straight on like a tunnel for some way, and then \
     dipped suddenly down, so suddenly that Alice had not a moment to think about \
     stopping herself before she found herself falling down a very deep well. Either the \
     well was very deep, or she fell very slowly, for she had plenty of time as she went \
